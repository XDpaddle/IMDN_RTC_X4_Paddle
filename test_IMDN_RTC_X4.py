...
parser.add_argument("--test_lr_folder", type=str, default='Test_Datasets/Set5_LR/x4/',
                    help='the folder of the input images')
parser.add_argument("--output_folder", type=str, default='results/Set5/x4')
parser.add_argument("--checkpoint", type=str, default='IMDN_RTC_checkpoint_x4/best.pdparams',
